...
def main():
    ...
    enrollFile = ("CabrilloEnrollment-" + timestamp + ".csv")
    term = '2025SP'
    classTotal = 700
    searchCriteriaUrl = 'https://success.cabrillo.edu/Student/Courses'
    searchCriteriaApiUrl = 'https://success.cabrillo.edu/Student/Courses/PostSearchCriteria'
    sectionUrl = 'https://success.cabrillo.edu/Student/Courses/Search'
    sectionApiUrl = 'https://success.cabrillo.edu/Student/Courses/Sections'
